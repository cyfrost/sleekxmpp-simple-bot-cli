...
class EchoBot(sleekxmpp.ClientXMPP):
    ...
    def __init__(self, jid, pwd, to_jid, message, is_verbose_logging_enabled):
...
if __name__ == "__main__":
    ...
    xmpp = EchoBot(from_jid, from_jid_pass, to_jid, message_to_send, is_verbose_logging_enabled)
